...
const AuthPage = () => {
  ...
  const authHandler = async (formValues) => {
    try {
      ...
      notification['error']({
        message: 'Error',
        description: e.message === httpCodes.FORBIDDEN ? 'Wrong githubId or password' : 'This githubId already exists',
    ...
    <>
      ...
      >
        ...
        <Form.Item label=" " colon={false}>
          ...
          <span style={{paddingLeft: '30px'}} onClick={() => setIsRegistrationPage(!isRegistrationPage)}>
